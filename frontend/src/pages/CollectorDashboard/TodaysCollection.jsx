...
function TodaysCollection() {
  ...
  const fetchTodayCollection = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        "http://localhost:5000/api/pickup/today-collection"
      );
      ...
      console.log("Today Collection Error:", error);
  ...
  const completionRate =
    collection.totalCollection > 0
      ? Math.round(
          (collection.completed / collection.totalCollection) * 100
        )
      : 0;
      ...
      <div className="collection-container">
        ...
        <div className="collection-cards">
          ...
          <div className="collection-card">
            ...
            <h2>{collection.totalCollection}</h2>
